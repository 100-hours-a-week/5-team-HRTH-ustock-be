...
public class GameAiService {
    ...
    private static String getPrompt() {
        return """
                ...
                단, 절대로 AI당 구매한 전체 종목의 가격(price)과 개수(quantity)의 곱의 총합이 AI가 보유 중인 예수금(budget)을 초과해서는 안돼.
                때문에 필요하다면 보유 종목을 판매해서 예수금을 충당해도 돼. 요청값에는 각 AI별로 할당된 힌트 목록, account 필드(예수금: budget, 보유 종목: holdings)이 들어 있어.
